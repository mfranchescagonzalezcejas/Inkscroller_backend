...
> Plantilla completada: [`docs/release/legacy/cloud-run/templates/p0-b1-evidence-template.md`](./templates/p0-b1-evidence-template.md)
...
- [`docs/DEPLOYMENT.md`](../../DEPLOYMENT.md) — proceso activo de deploy en Railway; este documento queda como evidencia histórica Cloud Run
- [`docs/release/checklist-legal.md`](../../checklist-legal.md) — checklist de compliance y tracking P0
- [`docs/release/legacy/cloud-run/templates/p0-b1-evidence-template.md`](./templates/p0-b1-evidence-template.md) — formato estándar de evidencia para P0-B1
